...
\begin{enumerate}[label=(\arabic*)]
  ...
  \item 次に, $G_2(s)=\dfrac{1}{0.2s+1}$, $K=1$ とするシステムを考える. 一巡伝達関数の
        ゲイン線図を問い (2) で描いたゲイン線図上に破線で描き, 単位ステップ入力を与えた時の
        応答を求めたうえで, 問い (2) と (3) で得られたゲイン線図や応答と比較し, 2 つの
        システムに関する過渡特性の違いについて考察せよ.
\end{enumerate}
