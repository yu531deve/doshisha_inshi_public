...
\begin{tikzpicture}[>=Latex]
  ...
  \draw[<->] (0,1.3) -- (6,1.3) node[midway,fill=white,inner sep=1pt]{$2L$};
  \draw[<->] (6.4,1.3) -- (10,1.3) node[midway,fill=white,inner sep=1pt]{$L$};
...
\begin{tikzpicture}[>=Latex]
  ...
  \node[left] at (-1.05,0.08) {$T_A$};
  % 反力
  \draw[->,very thick,blue] (8,-1.5) -- (8,-0.15) node[pos=0.35,left]{$R_B$};
  \draw[->,very thick,red] (8.6,-0.6) arc (-60:60:0.7);
  \node[red,right] at (8.95,0.55) {$M_B$};
