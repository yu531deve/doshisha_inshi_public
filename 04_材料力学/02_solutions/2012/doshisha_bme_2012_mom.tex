...
\begin{tikzpicture}[>=Latex,scale=1.0]
  ...
  \begin{scope}
    ...
    \node[left] at (0,-0.7) {$-P$}; \node[left] at (0,0.7) {$P$};
    \node[below,fill=white,inner sep=1pt] at (\L,-0.05) {$L$}; \node[below,fill=white,inner sep=1pt] at (2*\L,0) {$2L$};
  \end{scope}
  \begin{scope}[xshift=8.5cm]
    ...
    \node[above left,inner sep=1pt] at (0,0) {$A$}; \node[above,fill=white,inner sep=1pt] at (\L,0) {$B$}; \node[above] at (2*\L,0) {$C$};
  \end{scope}
\end{tikzpicture}
\end{center}
